...
<body bgcolor="#999999">
	<form method="post" action="add_trainers.php" enctype="multipart/form-data">
		<table width="794px" align="center" border="1" bgcolor="black">
			<tr>
				<td colspan="2" align="center"><h1 style="color:white">Add New Trainer</h1></td>
			</tr>
			<tr>
				<td align="right"><b style="color:white">Name Of Trainer</b></td>
				<td><input type="text" name="trainer_name"></td>
			</tr>
			<tr>
				<td align="right"><b style="color:white">Class</b></td>
				<td>
					<select name="trainer_class">
						<option style="color:white">Select a Class</option>
						<?php
			...
			<tr>
				<td align="right"><b style="color:white">Trainer Contact</b></td>
