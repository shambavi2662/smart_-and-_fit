...
<body bgcolor="#999999">
	<form method="post" action="add_exercises.php" enctype="multipart/form-data">
		<table width="794px" align="center" border="1" bgcolor="black">
			<tr>
				<td colspan="2" align="center"><h1 style="color:white">Insert Exercises</h1></td>
			</tr>
			<tr>
				<td align="right"><b style="color:white">Select User</b></td>
				<td>
					<select name="user">
						<option style="color:white">Select a User</option>
						<?php
			...
			<tr>
				<td align="right"><b style="color:white">Days</b></td>
				<td>
					<select name="day">
						<option style="color:white">Select a day</option>
						<?php
			...
			<tr>
				<td align="right"><b style="color:white">Name Of Exercise</b></td>
				<td><input type="text" name="exercise"></td>
			</tr>
			
			<tr>
				<td align="right"><b style="color:white">Number of Sets</b></td>
				<td><input type="text" name="sets"></td>
			</tr>
			<tr>
				<td align="right"><b style="color:white">Exercise Image</b></td>
