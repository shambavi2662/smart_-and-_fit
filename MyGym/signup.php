...
background-size:100% 100%;">
	...
	<div class="main_wrapper">
		...
		<div id="navbar" style="background-color:black">
			<ul id="menu">
			<li><a href="http://localhost/MyGym/MyGym/index1.php?">Main Page</a></li>
...
//Sign Up Script Start
  if (isset($_POST['user_signup']))
  {
	...
	elseif ($user_password==''<6) {
		echo "<script>alert('Please fill password with more than 5 letters or digits')</script>";
		exit();
	}
    elseif ($user_weight=='') {
      echo "<script>alert('Please fill out this field')</script>";
